...
//+kubebuilder:rbac:groups=opensearch.dremio.io,resources=opensearchuserrolebindings,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=opensearch.dremio.io,resources=opensearchuserrolebindings/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=opensearch.dremio.io,resources=opensearchuserrolebindings/finalizers,verbs=update
