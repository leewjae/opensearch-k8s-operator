...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchactiongroup,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchactiongroups,verbs=create;update,versions=v1,name=vopensearchactiongroup.opensearch.dremio.io,admissionReviewVersions=v1
