...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchismpolicy,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchismpolicies,verbs=create;update,versions=v1,name=vopensearchismpolicy.opensearch.dremio.io,admissionReviewVersions=v1
