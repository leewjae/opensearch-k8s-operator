...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchrole,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchroles,verbs=create;update,versions=v1,name=vopensearchrole.opensearch.dremio.io,admissionReviewVersions=v1
