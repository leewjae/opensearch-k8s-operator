...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchsnapshotpolicy,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchsnapshotpolicies,verbs=create;update,versions=v1,name=vopensearchsnapshotpolicy.opensearch.dremio.io,admissionReviewVersions=v1
