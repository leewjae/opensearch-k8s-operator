...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchcluster,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchclusters,verbs=create;update,versions=v1,name=vopensearchcluster.opensearch.dremio.io,admissionReviewVersions=v1
