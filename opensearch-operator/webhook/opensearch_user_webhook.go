...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchuser,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchusers,verbs=create;update,versions=v1,name=vopensearchuser.opensearch.dremio.io,admissionReviewVersions=v1
