...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchtenant,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchtenants,verbs=create;update,versions=v1,name=vopensearchtenant.opensearch.dremio.io,admissionReviewVersions=v1
