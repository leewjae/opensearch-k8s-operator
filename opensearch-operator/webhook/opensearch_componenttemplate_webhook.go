...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchcomponenttemplate,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchcomponenttemplates,verbs=create;update,versions=v1,name=vopensearchcomponenttemplate.opensearch.dremio.io,admissionReviewVersions=v1
