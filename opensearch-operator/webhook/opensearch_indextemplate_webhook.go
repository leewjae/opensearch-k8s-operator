...
//+kubebuilder:webhook:path=/validate-opensearch-dremio-io-v1-opensearchindextemplate,mutating=false,failurePolicy=fail,sideEffects=None,groups=opensearch.dremio.io,resources=opensearchindextemplates,verbs=create;update,versions=v1,name=vopensearchindextemplate.opensearch.dremio.io,admissionReviewVersions=v1
